        ...
        <div className="bg-base-300 rounded-xl p-6 space-y-8">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <img
                src={selectedImg || userInfo.profilePic || `https://avatar.iran.liara.run/username?username=${userInitials[0]}+${userInitials[1]}` || '/avatar.png'}
                alt="Profile"
          ...
          <div className="space-y-6">
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 bg-base-200 rounded-lg border">{userInfo?.fullName}</p>
            </div>
